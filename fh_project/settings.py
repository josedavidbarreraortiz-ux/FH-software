...
SECRET_KEY = 'django-insecure-fh-project-key-change-in-production'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = r'C:\Users\josed\Downloads\fh\fh'
...
EMAIL_HOST_PASSWORD = 'pnkz jwkz uxcm lbpg'    # ← Contraseña de aplicación de Gmail
